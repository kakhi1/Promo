...
// function Header() {
//   return (
//     <header className="bg-Bgcolor text-productBg ">
//       <div className=" container mx-auto flex justify-center p-5 items-center">
//         {/* Logo */}
//         <Link
//           to="/"
//           className="flex title-font font-normal items-center text-white mb-4 md:mb-0 w-1/3"
//         >
//           <img src={logo} alt="Logo" className=" h-10" />{" "}
//         </Link>
//         <div className="w-2/3 flex justify-between items-center">
//           {/* Search Bar */}
//           <div className="md:ml-auto md:mr-3 ">
//             <div class="relative">
//               <input
...
//           {/* Navigation Links */}
//           <div
//             className={`md:flex w-2/3 justify-start items-center ${
//               showMenu ? "flex" : "hidden"
//             }`}
//           >
// <nav className="md:ml-auto flex items-center lg:text-sm text-xs w-full justify-around ">
//   <Link
//     to="/brands"
